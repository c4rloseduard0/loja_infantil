...
-- -----------------------------------------------------
-- Table `loja`.`produto_has_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `loja`.`produto_has_category` ;

CREATE TABLE IF NOT EXISTS `loja`.`produto_has_category` (
  `produto_idproduto` INT NOT NULL,
